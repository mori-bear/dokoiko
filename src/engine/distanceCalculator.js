...
const DEPARTURE_REF_KEY = {
  ...
  '新宮':   'osaka',   '田辺':  'osaka',  '白浜':   'osaka',  '串本':  'osaka',
  '広島':   'osaka',   '岡山':  'osaka',  '松江':   'osaka',
  '倉敷':   'osaka',   '姫路':  'osaka',  '米子':   'osaka',  '福山':  'osaka',
  '鳥取':   'osaka',   '山口':  'osaka',  '下関':   'fukuoka',
  '函館':   'hakodate',
  '高松':   'takamatsu','松山': 'takamatsu','高知':  'takamatsu','徳島': 'takamatsu',
  '福岡':   'fukuoka', '熊本':  'fukuoka','鹿児島': 'fukuoka',
  '長崎':   'fukuoka', '宮崎':  'fukuoka', '佐賀':  'fukuoka', '大分': 'fukuoka', '別府':  'fukuoka',
  '那覇':   'naha',    '石垣':  'naha',   '宮古':   'naha',
  '釧路':   'sapporo', '帯広':  'sapporo','北見':   'sapporo',
  '秋田':   'sendai',  '山形':  'sendai', '福島':   'sendai', '八戸': 'sendai',
  '水戸':   'tokyo',   '前橋':  'tokyo',  '高崎':   'tokyo',  '甲府': 'tokyo',
  '浜松':   'nagoya',  '岐阜':  'nagoya', '福井':   'osaka',
};
